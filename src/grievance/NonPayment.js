...
export default function NonPayment({ mainCat }) {
  ...
  return (
    <>
      <Grid container spacing={2}>
        <Grid item xs={12} sx={{marginTop:'20px'}} component="form" noValidate onSubmit={handleSubmit}>
          ...
          <Grid item xs={12}>
            <Button sx={{marginTop:'20px'}} variant="contained" type="submit" endIcon={<SendIcon />}>
              Submit
            </Button>
          </Grid>
        </Grid>
